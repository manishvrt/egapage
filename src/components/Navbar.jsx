    ...
    <div className="bg-white ">
        <div className="px-4 mx-auto sm:px-6 lg:px-8">
            <nav className="relative flex items-center justify-between h-16 lg:h-20">
                <div className="hidden lg:flex small lg:items-center lg:space-x-10">
                ...
                <div className="lg:absolute lg:-translate-x-1/2 lg:inset-y-5 lg:left-1/2">
                    <div className="flex-shrink-0">
                        <a href="#" title="" className="flex items-center gap-3">
                            <img className="w-auto h-8 lg:h-10" src="http://www.vrt9.net/edge/vrtlogo.svg" alt="" />
                            <h1 className="text-xl gsans font-bold text-black">
                ...
                <div className="hidden small lg:flex lg:items-center lg:space-x-10">
                    <a href="#" title="" className="text-base bg-[#ff0000] h-10 flex justify-center items-center rounded-3xl px-6 font-medium text-white"> 
                        Talk to Rajesh Tedla
                    </a>
